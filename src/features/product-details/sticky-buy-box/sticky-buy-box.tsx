...
export function StickyBuyBox({ product, targetId = 'main-add-to-cart' }: StickyBuyBoxProps) {
  ...
  return (
    <div className="fixed bottom-0 inset-x-0 z-40 bg-background/95 backdrop-blur-md border-t border-border/80 shadow-2xl py-3 px-4 sm:px-8 safe-area-bottom-with-padding animate-in slide-in-from-bottom duration-300">
